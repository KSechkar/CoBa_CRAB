...
def odeuus(t, x, # simulation time and state vector
    ...
    q_het, = args[5]  # unpack jax-arrayed synthetic gene parameters for calculating heterologous genes' resource demand
    ...
    # resource demand of heterologous genes
    q_het = jnp.sum(Fs * q_het)  # heterologous gene resource demand
